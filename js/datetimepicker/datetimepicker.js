...
gj.widget = function() {
    ...
    function(a) {
        ...
        base: {
            ...
            icons: {
                expand: '<i class="fa fa-arrow-right" />',
    ...
    function(a) {
        ...
        base: {
            ...
            icons: {
                ...
                previousMonth: '<i class="fa fa-arrow-left"></i>',
                nextMonth: '<i class="fa fa-arrow-right"></i>'
            },
            fontSize: void 0,
            size: "default",
            modal: !1,
